...
typedef struct
{
	ST_PDPContxt_Callback   pdp_state_change_ind_fcn;
	void                                *user_param;
}ST_PDPContxt_State_Mgr;
...
*                   Within all of the PDP context, 6 socket links can be created.
*
*               callback_func:
...
*                   ret = Ql_GPRS_GetLocalIPAddress(0, (u8 *)ip_addr);
*                   if (GPRS_PDP_SUCCESS == ret)
*                   {
...
s32   Ql_GPRS_GetLocalIPAddress(u8 contextId, u8* ipAddr);
...
*                   ret = Ql_GPRS_GetDNSAddress(0, (u8*)ipAddr_1st, (u8*)ipAddr_2st);
*                   if (GPRS_PDP_SUCCESS == ret)
*                   {
...
*               }
*****************************************************************/
s32   Ql_GPRS_GetDNSAddress(u8 contextId, u8* firstAddr, u8* secondAddr);
...
*
*               firstAddr:
*                   [in] Point to the buffer that stores the primary DNS address.
*
*               secondAddr:
*                   [in]Point to the buffer that stores the second DNS address.
*
* Return:
*               GPRS_PDP_SUCCESS:
*                   This function succeeds.
...
*               {
*                   s32 ret;
*                   u8 ip_dns1[40] = "208, 67, 222, 222";
*                   u8 ip_dns1[40] = "8, 8, 8, 8";
...
*               }
******************************************************************/
s32  Ql_GPRS_SetDNSAddress(u8 contextId, u8 *firstAddr, u8 *secondAddr);
