...
*                   [In] slave address.
*               IicSpeed:
*                   [in] just for hardware IIC interface,and the parameter can be ingore if you use simulated IIC.
*
*                   The valid of the value is [0-400], Unit in kbps.
*
*                   Note:
*                     Standard mode, supports up to 100Kbps.
*                     Fast mode, supports up to the level of 400Kbps, and the real value is 384Kbps.
*
* Return:        
*               QL_RET_OK, this function succeeds.
...
/*****************************************************************
* Function:     Ql_IIC_WriteReg 
* 
* Description:
*               This function  write value to the specified register
*               on IIC slave device.
*               
* Parameters:
*               chnnlNo:
...
*               QL_RET_ERR_IIC_SLAVE_NOT_FOUND, not found the specified slave.
*****************************************************************/
//s32 Ql_IIC_WriteReg(u32 chnnlNo,u8 slaveAddr, u8 regAddr, u8* pData, u32 len);
