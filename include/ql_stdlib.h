...
typedef __builtin_va_list Ql_va_list;

#define Ql_va_arg(ap, type) __builtin_va_arg((ap), type)
#define Ql_va_copy(dest, src) __builtin_va_copy((dest), (src))
#define Ql_va_end(ap) __builtin_va_end((ap))
#define Ql_va_start(ap, parmN) __builtin_va_start((ap), (parmN))
...
extern s32 (*Ql_vsprintf)(const char *, const char *, Ql_va_list);
