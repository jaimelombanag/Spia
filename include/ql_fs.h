...
*  
* Description:
*               Opens or creates a file with a specified name in the UFS or SD card,RAM. 
...
*               If you want to create a file in the RAM , you also need to add prefix "RAM:"
*               in front of the file name.
*
* Parameters:    
*               lpFileName:
*                   [in]The name of the file. The name is limited to 80 characters.
...
*                       to 80 characters. You must use a relative path, such as 
...
*  
* Description:
*               Rename a file in the UFS or SD card.
*
* Parameters:    
*               lpFileName:
*                  [in] File to be renamed.The name is limited to 80 characters. 
*                       You must use a relative path, such as "filename.ext" or 
*                       "dirname\filename.ext".
*
*               newLpFileName:
*                  [in] New name of file. The name is limited to 80 characters. 
*                       You must use a relative path, such as "filename.ext" or 
*                       "dirname\filename.ext".
* Return:  
*               QL_RET_OK, success.
...
* Parameters:    
*               lpDirName:
*                   [in] The name of the directory.The name is limited to 80 characters.
...
*  
* Description:
*               Deletes an existing directory in the UFS or SD card. 
*
* Parameters:    
*               lpDirName:
*                   [in] The name of the directory.The name is limited to 80 characters.
...
*  
* Description:
*               Check whether the file exists or not in the UFS or SD card. 
*
* Parameters:    
*               lpDirName:
*                   [in] The name of the directory.The name is limited to 80 characters.
