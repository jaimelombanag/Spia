...
* Return:        
*            QL_RET_OK: send message succeeds. 	
*            QL_RET_ERR_PARAM£ºsend message failure
...
*
* Return:        
*			An event Id that identify this event uniquely.0 indicates failure.
*****************************************************************/
...
*****************************************************************/
s32 Ql_OS_GetOSLastErrorCode(void);
...
*               None
* Return:        
*               Task priority, ranges from 200 to 239.
*****************************************************************/
u32 Ql_OS_GetCurrentTaskPriority(void);


/*****************************************************************
* Function:     Ql_OS_ChangeTaskPriority 
* 
* Description:
*               Change the priority of the current task
...
*               Task priority, ranges from 200 to 239.
*****************************************************************/
u32  Ql_OS_ChangeTaskPriority( u32 newpriority);
